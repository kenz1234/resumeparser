...
if __name__ == "__main__":
    input_folder = os.path.abspath("C:/Users/Kenz/PycharmProjects/PythonProject/Resumestr")
    output_folder = os.path.abspath("C:/Users/Kenz/PycharmProjects/PythonProject/Resumestr")
